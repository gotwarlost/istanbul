...
module.exports = {
    setUp: function (cb) {
        ...
        helper.resetOpts();
        runCover([ 'test/run.js', '--report', 'none', '--no-include-all-sources' ], function (/* results */) {
            // Mutate coverage.raw.json to test relative key paths.
            var covObj = require('./sample-project/coverage/coverage.raw.json');
            var relCovObj = {};
