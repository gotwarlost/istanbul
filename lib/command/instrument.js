    ...
    usage: function () {
        console.error('\nUsage: ' + this.toolName() + ' ' + this.type() + ' <options> <file-or-directory>\n\nOptions are:\n\n' +
            [
                ...
                formatOption('--[no-]auto-wrap', '[do not] automatically wrap the source in an anonymous function before covering it, ' +
                    'defaults to true'),
