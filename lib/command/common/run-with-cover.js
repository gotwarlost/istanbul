    ...
    if (enableHooks) {
        ...
        matcherFor({
            ...
            function (err, matchFn) {
                ...
                // run InNewContext is usefull for mocking deps in unit tests http://howtonode.org/testing-private-state-and-mocking-deps
                if (config.hooks.hookRunInContext()) {
                    hook.hookRunInThisContext(matchFn, transformer, hookOpts);
                    hook.hookRunInNewContext(matchFn, transformer, hookOpts);
                }
