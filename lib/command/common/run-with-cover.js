...
function usage(arg0, command) {
    ...
    console.error('\nUsage: ' + arg0 + ' ' + command + ' [<options>] <executable-js-file-or-command> [-- <arguments-to-jsfile>]\n\nOptions are:\n\n'
        + [
            ...
            formatOption('--remap', 'remap coverage to original source positions based on source maps'),
        ...
        matcherFor({
            ...
            function (err, matchFn) {
                ...
                process.once('exit', function () {
                    ...
                    if (config.reporting.remap()) {
                      // We require it here to pass tests on Node.js v0.10
                      collector = require('remap-istanbul/lib/remap')(cov);
                    } else {
