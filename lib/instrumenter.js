...
(function (isNode) {
    ...
    SYNTAX = {
        ...
        ArrowFunctionExpression: [ 'id', 'params', 'defaults', 'body', 'rest', 'generator', 'expression' ],
        ...
        ExportBatchSpecifier: [ /* no children? */],
        ExportSpecifier: [ 'id', 'name'],
        ExpressionStatement: [ 'expression'],
        ForInStatement: [ 'left', 'right', 'body' ],
        ForOfStatement: [ 'left', 'right', 'body' ],
        ForStatement: ['init', 'test', 'update', 'body' ],
        FunctionDeclaration: ['id', 'params', 'defaults', 'body', 'rest', 'generator', 'expression' ],
        FunctionExpression: ['id', 'params', 'defaults', 'body', 'rest', 'generator', 'expression' ],
        Identifier: [],
        IfStatement: ['test', 'consequent', 'alternate'],
        ImportDeclaration: [ 'specifiers', 'kind', 'source' ],
        ImportSpecifier: [ 'id', 'name' ],
        LabeledStatement: ['label', 'body'],
        Literal: [],
        LogicalExpression: [ 'left', 'right' ],
        MemberExpression: ['object', 'property'],
        MethodDefinition: [ 'key', 'value', 'kind', 'static' ],
