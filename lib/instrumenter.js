...
(function (isNode) {
     ...
     * @param {Boolean} [options.comment] preserve comments in instrumented code
     *
    ...
    Instrumenter.prototype = {
        ...
        instrumentSync: function (code, filename) {
            ...
            program = ESP.parse(code, {
                loc: true,
                range: this.opts.comment,
                tokens: this.opts.comment,
        ...
        instrumentASTSync: function (program, filename, originalCode) {
            ...
            var codegenOptions = this.opts.codeGenerationOptions || {
                comment: this.opts.comment,
