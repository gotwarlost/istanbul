...
/**
 * returns if `vm.runInThisContext` and 'vm.runInNewContext' need to be hooked, in
 * addition to the standard `require` hooks added by istanbul. This should be true for
 * code that uses RequireJS or if using a `require` shim to mock dependencies in unit tests.
 * Used by the `cover` command.
