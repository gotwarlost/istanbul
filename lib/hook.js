...
var path = require('path'),
    ...
    vm = require('vm'),
    originalLoaders = {},
    originalScript = vm.Script,
    originalCreateScript = vm.createScript,
    originalRunInThisContext = vm.runInThisContext,
    originalRunInContext = vm.runInContext,
    originalRunInNewContext = vm.runInNewContext,
    originalScriptProtoOfRunInContext = originalScript.prototype.runInContext,
    originalScriptProtoOfRunInNewContext = originalScript.prototype.runInNewContext;
...
function populateContext(context, injectScope) {
    var scope = injectScope ? Object.keys(injectScope) : [];
...
function hookCreateScript(matcher, transformer, opts) {
    ...
    originalScript.prototype.originalRunInContext = originalScriptProtoOfRunInContext;
    originalScript.prototype.originalRunInNewContext = originalScriptProtoOfRunInNewContext;

    originalScript.prototype.runInContext = function(context, options) {
        populateContext(context, opts.injectScope);
        return this.originalRunInContext(context, options);
    };
    originalScript.prototype.runInNewContext = function(context, options) {
        populateContext(context, opts.injectScope);
...
function unhookCreateScript() {
    ...
    if (originalScript.prototype.originalRunInContext) {
        originalScript.prototype.runInContext = originalScript.prototype.originalRunInContext;
        delete originalScript.prototype.originalRunInContext;
    }
    if (originalScript.prototype.originalRunInNewContext) {
        originalScript.prototype.runInNewContext = originalScript.prototype.originalRunInNewContext;
        delete originalScript.prototype.originalRunInNewContext;
    }
}
...
module.exports = {
    ...
    hookRunInNewContext : hookRunInNewContext,
    unhookRunInThisContext : unhookRunInThisContext,
    unhookRunInContext : unhookRunInContext,
    unhookRunInNewContext : unhookRunInNewContext,
