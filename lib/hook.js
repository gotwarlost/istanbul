...
function hookCreateScript(matcher, transformer, opts) {
    ...
    var orgRunInContext = originalScript.prototype.runInContext,
        orgRunInNewContext = originalScript.prototype.runInNewContext;

    originalScript.prototype.originalRunInContext = orgRunInContext;
    originalScript.prototype.originalRunInNewContext = orgRunInNewContext;
