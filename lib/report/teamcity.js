...
Report.mix(TeamcityReport, {
    ...
    writeReport: function (collector /*, sync */) {
        ...
        //Branches (blocks) Covered
        lines.push(lineForKey(finalSummary.branches.covered, 'CodeCoverageAbsBCovered'));
        lines.push(lineForKey(finalSummary.branches.total, 'CodeCoverageAbsBTotal'));
        lines.push(lineForKey(finalSummary.branches.pct, 'CodeCoverageB'));
