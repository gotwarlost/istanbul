...
var headerTemplate = templateFor('head-flow'),
    ...
    summaryLineTemplate = handlebars.compile(
        ...
        '<td class="{{metrics.statements.class}}" title="{{metrics.statements.stats}}" data-uncovered="{{metrics.statements.uncovered}}">' +
            '<svg><use xlink:href="#checkmark"></use></svg>' +
        '</td>\n' +
        '<td class="{{metrics.branches.class}}" title="{{metrics.branches.stats}}" data-uncovered="{{metrics.branches.uncovered}}">' +
            '<svg><use xlink:href="#checkmark"></use></svg>' +
        '</td>\n' +
        '<td class="{{metrics.functions.class}}" title="{{metrics.functions.stats}}" data-uncovered="{{metrics.functions.uncovered}}">' +
            '<svg><use xlink:href="#checkmark"></use></svg>' +
        '</td>\n' +
        '</tr>\n'
    ),
